...
var actorChars = {
  ...
  //"+": MovPlat,
  "o": Coin,
  "$": boost,  // A coin will wobble up and down
  "=": Lava, "|": Lava, "v": Lava  
...
MovPlat.prototype.type = "MovPlat";
...
MovPlat.prototype.act = function(step, level) {
  var newPos = this.pos.plus(this.speed.times(step));
  if (!level.obstacleAt(newPos, this.size))
    this.pos = newPos;
  else if (this.repeatPos)
